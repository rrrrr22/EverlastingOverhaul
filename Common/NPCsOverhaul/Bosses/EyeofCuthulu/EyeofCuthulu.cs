...
public class EyeRiftObject : ModObject
{
    ...
    public Tween<Vector2> scaleTween;
    public override void SetDefaults()
    {
        timeLeft = MaxTimeLeft;
        scaleTween = new Tween<Vector2>(Vector2.Lerp).TweenProperty(
            [
                new(new Vector2(0, 0), new Vector2(256, 256), false, TweenEaseType.None, 10),
                new(new Vector2(256, 256), new Vector2(256, 256), true, TweenEaseType.None, 20),
                new(new Vector2(256, 256), new Vector2(0, 0), false, TweenEaseType.None, 10)
            ]
        );
    }
    public override void AI()
    ...
    {
        default(EyeRift).Draw(position, rotation, size);
    }
}
public class LingeringEvilFlames : ModProjectile
{
    ...
    public override void SetDefaults()
    {
        ...
        scaleTween = new Tween<float>(MathHelper.Lerp).TweenProperty(
            [
                new(0, 1, false, TweenEaseType.None, 10),
                new(1, 1, true, TweenEaseType.None, 320),
                new(1, 0, false, TweenEaseType.None, 30)
            ]
        );
    }
    ...
    public override void OnSpawn(IEntitySource source)
    {
        ...
        //new Tween<float>(MathHelper.Lerp, ref Projectile.scale, false).SetProperties(0, 1, TweenEaseType.None, 10,
        //new Tween<float>(MathHelper.Lerp, ref Projectile.scale, false).SetProperties(1, 1, TweenEaseType.None, 320, 
        //new Tween<float>(MathHelper.Lerp, ref Projectile.scale, false).SetProperties(1, 0, TweenEaseType.None, 30)));
